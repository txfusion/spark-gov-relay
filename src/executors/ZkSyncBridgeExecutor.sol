...
/**
 * @title ZkSyncBridgeExecutor
 * @author Aave
 * @notice Implementation of the ZkSync Bridge Executor, able to receive cross-chain transactions from Ethereum
...
contract ZkSyncBridgeExecutor is L2BridgeExecutor {
    uint160 internal constant OFFSET =
        uint160(0x1111000000000000000000000000000000001111); //need to use zksync offset
